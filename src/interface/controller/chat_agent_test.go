...
func TestExec_Mention(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "usecase succeeds", execErr: nil, wantStatus: http.StatusOK},
		{name: "usecase fails", execErr: errors.New("boom"), wantStatus: http.StatusInternalServerError},
	}
